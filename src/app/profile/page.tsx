    ...
    <div className="space-y-8 pb-20 w-full px-4 sm:px-6 lg:px-12 pt-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-8 space-y-8">
          ...
          {/* Profile Form Card */}
          <div className="bg-secondary/10 border border-border/30 rounded-3xl p-6 md:p-8 backdrop-blur-xl">
          ...
          <div className="bg-secondary/10 border border-border/30 rounded-3xl p-6 md:p-8 backdrop-blur-xl space-y-6">
